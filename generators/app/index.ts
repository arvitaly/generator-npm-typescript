...
class NpmTypescriptGenerator extends Generator {
    public writing() {
        ...
        const packageContent = this.fs.readJSON(
        ...
        const author =
            ...
            packageContent.homepage.indexOf("github.com") > -1
                ? packageContent.homepage
        ...
        this.yarnInstall(
            ["coveralls", "jest", "typescript", "tslint", "@types/jest"],
            { dev: true },
        );
    }
